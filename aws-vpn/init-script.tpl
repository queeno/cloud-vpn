...
- content: |
    ...
    docker run -v $OVPN_DATA:/etc/openvpn --rm kylemanna/openvpn ovpn_genconfig -u udp://${dns_name}
...
runcmd:
- apt-get update && apt-get install -y haveged apt-transport-https ca-certificates curl gnupg-agent software-properties-common
